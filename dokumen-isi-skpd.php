...
?>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Usulan Anggaran Perubahan | <a href="<?php echo "cetak-usulan-skpd.php?id=$cekid_skpd" ?>" > <i class="ti ti-printer"></i> Cetak Pdf</a> | <a href="<?php echo "cetak_excel_skpd.php?id=$cekid_skpd" ?>" > <i class="ti ti-printer"></i> Cetak Excel</a> </h4>

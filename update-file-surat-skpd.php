        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Surat Pengajuan Anggaran Belanja Perubahan</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Update File Surat</a></li>
                        <li class="breadcrumb-item active"><?php echo $nama_skpd_admin?></li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
             ...
             <?php include "update-file-surat-isi-skpd.php";?>   
               <!-- Ending isi  -->
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="src/assets/libs/select2/dist/css/select2.min.css">
    <!-- Custom CSS -->
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Update Password User</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Update Password Admin / User</li>
                    </ol>
                </div>
                <?php include "pages/grafic-admin.php";?>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
             ...
             <?php include "password-update-isi.php";?>   
               <!-- Ending isi  -->
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
	...
	<script src="src/assets/libs/select2/dist/js/select2.full.min.js"></script>
    <script src="src/assets/libs/select2/dist/js/select2.min.js"></script>

...
<table width="100%" border="0" style="border-bottom:thin; border-color:#333333" >
  <tr>
    ...
    <td width="82%" align="center"> <h4 align="center"> <br>DAFTAR USULAN ANGGARAN PERUBAHAN <br>  TAHUN <?PHP echo $year1; ?></h4></td>
                                    ...
                                    <table  width="100%" id="table1" style="font-size:12px">
                                        ...
                                        <tbody>
											...
											$anggaran_2	 		= rupiah_2($total_anggaran); 
												...
												$cetak_total_2		= rupiah_2($anggaran_perubahan_skpd); 

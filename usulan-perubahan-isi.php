...
?>
                    ...
                    <div class="col-lg-4 col-md-12">
					 <div class="card">
							...
							<form class="form-horizontal mt-4" action="assets/proses/input-usulan-perubahan.php" method='post' enctype='multipart/form-data'>
															<div class="form-group">
																<label>Dasar Surat </span></label>
																<select class="custom-select col-12" id="inlineFormCustomSelect" name="id_surat" required >
																	<option value="">Choose...</option>
																	<?PHP
																	include "assets/combo/surat-admin.php";
																	for ($i=0;$i<$count;$i++)
																	{

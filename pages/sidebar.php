                    ...
                    <ul id="sidebarnav">
                        <li class="nav-small-cap"><i class="mdi mdi-yin-yang"></i>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="surat-pengajuan.php" aria-expanded="false"><i class="ti ti-briefcase"></i><span
                                    class="hide-menu">Surat Pengajuan</span></a></li>	
						 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="usulan-perubahan.php" aria-expanded="false"><i class="ti ti-pencil-alt"></i><span
						...
						<li class="nav-small-cap">
						 ...
						 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="dokumen.php" aria-expanded="false"><i class="ti ti-printer"></i><span
                                    class="hide-menu">Cetak Dokumen</span></a></li>
						 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="dokumen-per-skpd.php" aria-expanded="false"><i class="ti ti-printer"></i><span
                                    class="hide-menu">Cetak per SKPD</span></a></li>
					
                      
						 <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i>
                            <span class="hide-menu">Extra</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="skpd.php" aria-expanded="false"><i
                                    class="icon icon-home"></i><span class="hide-menu"> SKPD</span></a>                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="user.php" aria-expanded="false"><i
                                    class="icon icon-user"></i><span class="hide-menu"> User</span></a></li>

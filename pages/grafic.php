...
function rupiah_4($angka){
	...
	return $hasil_rupiah;
			 								...
			 								//tampil
					$year1				= date("Y");
					$sql_00001			= "select SUM(anggaran_awal) as anggaran_awal_skpd from usulan_perubahan where id_skpd='$cekid_skpd' and tahun ='$year1' ";
					...
					$sql_000012			= "select SUM(anggaran_susulan) as anggaran_perubahan_skpd from usulan_perubahan where id_skpd='$cekid_skpd' and tahun ='$year1' ";

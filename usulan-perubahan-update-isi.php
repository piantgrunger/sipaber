...
<?php
			 ...
			 $jml_1			= mysqli_num_rows($sql_01);
				...
				$id_usul 			=  $_GET['id'];
				$sql_00				= "select * from usulan_perubahan  where id_usulan='$id_usul'";
				$sql_kk 			= mysqli_query($conn, $sql_00);
				$data_kk 			= mysqli_fetch_array($sql_kk);
				$id_surat			= $data_kk['id_surat'];
				$id_skpd			= $data_kk['id_skpd'];
				$kd_rekening		= $data_kk['kd_rekening'];
				$program			= $data_kk['program'];
				$kegiatan			= $data_kk['kegiatan'];
				$objek_belanja		= $data_kk['objek_belanja'];
				$uraian				= $data_kk['uraian'];
				$anggaran_awal		= $data_kk['anggaran_awal'];
				$anggaran_susulan	= $data_kk['anggaran_susulan'];
				$keterangan			= $data_kk['keterangan'];
				
				$sql_000			= "select * from surat_pengajuan  where id_surat='$id_surat'";
				$sql_kk1 			= mysqli_query($conn, $sql_000);
				$data_kk1 			= mysqli_fetch_array($sql_kk1);
				$no_surat			= $data_kk1['no_surat'];
                    ...
                    <div class="col-lg-4 col-md-12">
					 <div class="card">
                            <div class="card-body bg-warning rounded-top">
                                <h4 class="text-white card-title">Update Usulan Perubahan Anggaran Belanja
								</h4>
                            </div>
                            <div class="card-body">
							
							
							<form class="form-horizontal mt-4" action="assets/proses/update-usulan-perubahan.php" method='post' enctype='multipart/form-data'>
															<div class="form-group">
															<div class="form-group">
																<label>SKPD </span></label>
																<input type="text" class="form-control" required value ="<?php echo $nama_skpd; ?>" disabled>
															</div>
															
																<label>Dasar Surat </span></label>
																<select class="custom-select col-12" id="inlineFormCustomSelect" name="id_surat" required >
																	<option value="<?php echo $id_surat; ?>"><?php echo $no_surat; ?></option>
																	<?PHP
																	include "assets/combo/surat-update-admin.php";
																	for ($i=0;$i<$count;$i++)
																	{
															...
															<div class="form-group">
																...
																<input type="hidden" class="form-control" value ="<?php echo $id_usul; ?>"   name="id_usulan"   >
																<input type="text" class="form-control"   name="kode_rek"   value ="<?php echo $kd_rekening; ?>">
																<small id="textHelp" class="form-text text-muted">Bisa dikosongkan</small>
															</div>
															<div class="form-group">
																<label>Program </span></label>
																<input type="text" class="form-control" placeholder="Nama Program" name="program"  required value ="<?php echo $program; ?>">
															</div>
															<div class="form-group">
																<label>Kegiatan </span></label>
																<input type="text" class="form-control" placeholder="Nama Kegiatan" name="kegiatan"  required value ="<?php echo $kegiatan; ?>">
															</div>
															<div class="form-group">
																<label>Objek Belanja </span></label>
																<input type="text" class="form-control" placeholder="Nama Objek Belanja" name="objek_belanja"  required value ="<?php echo $objek_belanja; ?>">
															</div>
															<div class="form-group">
																<label>Uraian</span></label>
																<div class="form-group">
																	<textarea name="uraian" class="form-control" rows="2" placeholder="Uraian..." required><?php echo $uraian; ?></textarea>
																	
																</div>
															</div>
															<div class="form-group">
																<label>Anggaran Semula (Rp.)</span></label>
																<input type="number" class="form-control"   name="anggaran_0"  required value ="<?php echo $anggaran_awal; ?>">
															...
															<div class="form-group">
																...
																<input type="number" class="form-control"  placeholder="Usulan ABT" name="anggaran_1"  required value ="<?php echo $anggaran_susulan; ?>">
															...
															<div class="form-group">
																...
																<div class="form-group">
																	<textarea name="keterangan" class="form-control" rows="2" placeholder="Keterangan..."><?php echo $keterangan; ?></textarea>
																	<small id="textHelp" class="form-text text-muted">Bisa dikosongkan</small>
																</div>
															</div>

        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Data Usulan Perubahan Anggaran Belanja Per SKPD</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Usulan Perubahan Anggaran Belanja Per SKPD</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
             ...
             <?php include "dokumen-per-skpd-isi.php";?>   
               <!-- Ending isi  -->
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->

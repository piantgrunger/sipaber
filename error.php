        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Error Page</h3>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Hai, Kamu sedang Error. Ngopi dulu yaks.</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
              <!-- Ngisi disini  -->  
					...
					<div class="error-body text-center">
						...
						<h3 class="text-uppercase error-subtitle">KESALAHAN INPUT, CEK KEMBALI INPUT PIAN !</h3>
						<p class="text-muted mt-4 mb-4">JANGAN LUPA BACA BISMILLAH, AYO NGOPI DULU</p>
						<a href="admin.php" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Back to home</a> 
					</div>
